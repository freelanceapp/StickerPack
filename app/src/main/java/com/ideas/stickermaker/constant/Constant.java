package com.ideas.stickermaker.constant;

public class Constant {

    /*http://stickerapp.fun/androidapi/sticker-likes.php*/
    public static final String BASE_URL = "http://stickerapp.fun/";
    public static final String CONTENT_API = "androidapi/content.php?";
    public static final String CATEGORY_API = "androidapi/all-response.php";
