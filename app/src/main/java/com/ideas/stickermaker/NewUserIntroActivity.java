...
public class NewUserIntroActivity extends IntroActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSlide(new SimpleSlide.Builder()
                .title("Welcome to Love StickerList for WhatsApp!")
        ...
        addSlide(new SimpleSlide.Builder()
                ...
                .description("You can start creating your sticker packs!\n\n" +
                        "Please notice! StickerList packs created or loaded with the app require the app being installed on device.\n\n" +
